...
class ModifyUserStatus(LoginRequiredMixin, View):
    ...
    @method_decorator(permission_required("auth.change_user", login_url="user_list"))
    def get(self, request, *args, **kwargs):
        return super(UserListView, self).get(request, *args, **kwargs)


class ModifyUserGroup(LoginRequiredMixin, View):
